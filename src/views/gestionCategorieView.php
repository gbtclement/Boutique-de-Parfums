...
<?php require_once __DIR__ . '/../controllers/gestionCategorieController.php'; ?>
...
<div class="marginPage">
    <div class="gestionCateg">
        ...
        <div class="creationCateg">
            ...
            <form action="index.php?action=create" method="POST"> <!-- Action mise à jour -->
        ...
        <div class="listCateg">
            ...
            <form action="index.php?action=delete" method="POST" id="deleteForm"> <!-- Action mise à jour -->
                <table>
                    <thead>
                        <tr>
                            <th>Sélectionner</th>
        ...
        <div class="modifCateg" id="modifCateg" style="display: none;">
            ...
            <form action="index.php?action=update" method="POST"> <!-- Action mise à jour -->
